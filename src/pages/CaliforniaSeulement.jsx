    ...
    <div>
      ...
      <div className="row">
        {menus
          ...
          .map(m => (
            <div className="col-12 col-sm-6 col-md-4 mx-5" key={m.id}>
              <div className="card border-0 rounded-0 position-relative p-0 mt-5 mx-5" style={{ backgroundColor: "#F4F1E8" , cursor: "pointer" }}
